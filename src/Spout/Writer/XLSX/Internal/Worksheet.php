...
EOD;
    ...
    {
		if( $this->isHyperlink($cellValue) ){ 
			return $this->hyperlinkXml($cellValue); 
		}
	...
	private function isHyperlink($cellValue){
		return strpos( $cellValue, '=HYPERLINK' ) === 0;
	}
	
	private function hyperlinkXml($cellValue){
		$matches = array();
